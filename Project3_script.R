...
df_tvn_E <- as.data.frame(t(df_tvn_E))
...
df_tvn_D <- apply (df_D, MARGIN = 1, FUN = function(x) {x/sum(x)})
df_tvn_D <- as.data.frame(t(df_tvn_D))
...
df_tvn_C <- apply (df_C, MARGIN = 1, FUN = function(x) {x/sum(x)})
df_tvn_C <- as.data.frame(t(df_tvn_C))
...
df_tvn_B <- apply (df_B, MARGIN = 1, FUN = function(x) {x/sum(x)})
df_tvn_B <- as.data.frame(t(df_tvn_B))
...
df_tvn_A <- apply (df_A, MARGIN = 1, FUN = function(x) {x/sum(x)})
df_tvn_A <- as.data.frame(t(df_tvn_A))
