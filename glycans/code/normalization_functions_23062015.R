####### new round of normalizations
### script started on 23062015 (update of previous version of the script)
# changed - different combinations of normalizations are tested

# normalization functions for simulations studies and rest... started in 27.08.2014.
# globalNorm and largestPeakNorm taken from Frano
# d and f_data need to be raw glycans (as extracted from the machine, no previous cleaning performed)
