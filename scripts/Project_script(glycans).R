...
setwd(dir = "/media/rostyslav/Toshiba/Projects/RSSSO_glycans")

dat <- read.csv("00-scripts-data/data/ultimate_igg-areas-20150417.csv")
dat <- dat[, -(c(5:7))]
...
f <- function(dat){
  ...
  Reduce(function(x, y) merge(x, y, all=TRUE), list(MedQM, QN, TAN))
}
